...
<section className={`text-center py-8 px-4 ${bgCard} shadow-lg animate-fade-in`}>
  ...
  <p className={`${textSecondary} mb-6 text-lg`}>
    🎉 Get ready! Listings are live! 🎉 <a href="https://pancakeswap.finance/swap?inputCurrency=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c&outputCurrency=0x11d2e5FB3EB729fc829baee1d2ADa09bFa4EC4D7" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-400">PancakeSwap</a> 
  </p>
